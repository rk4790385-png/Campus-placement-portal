...
export function SiteHeader() {
    return (
        <header className="sticky top-0 z-40 border-b border-border/70 backdrop-blur-xl bg-background/80">
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
                <Link to="/" className="flex items-center gap-2">
                    ...
                    <div className="leading-tight">
                        <div className="text-sm font-bold tracking-tight">Campus Placement</div>
                        <div className="text-[10px] font-medium tracking-[0.18em] text-muted-foreground -mt-0.5">PORTAL</div>
                    </div>
                </Link>
